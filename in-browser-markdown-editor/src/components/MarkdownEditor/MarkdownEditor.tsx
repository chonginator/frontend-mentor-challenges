...
function MarkdownEditor() {
  ...
  return (
    <div className="relative flex h-dvh">
      {showMarkdown && (
        <div className="tw-w-full flex flex-1 flex-col">
          ...
          <textarea
            className="flex-1 resize-none bg-gray-100 p-4 font-mono  text-sm/6 text-gray-700 dark:bg-gray-1000 dark:text-gray-400"
            value={markdown}
      ...
      <div
        className={cn("hidden flex-1 flex-col md:flex", {
          flex: !showMarkdown,
        })}
      >
        ...
        <ReactMarkdown
          className="flex flex-1 flex-col gap-5 overflow-auto bg-gray-100 p-6 dark:bg-gray-1000 dark:text-gray-400"
          components={{
            h1: ({ children, ...props }) => (
              <h1
